...
public class Config {
    ...
    public static ModConfigSpec.BooleanValue ETERNAL_TOTEM_TANK_CONVERSION;

    // ==================== 农场 ====================
    public static ModConfigSpec.IntValue FARM_LEVEL_UP_INTERVAL_SECONDS;
    public static ModConfigSpec.LongValue FARM_CARRY;
    public static ModConfigSpec.LongValue FARM_INITIAL_LEVEL;
    public static ModConfigSpec.LongValue FARM_MAX_LEVEL;
    public static ModConfigSpec.ConfigValue<List<? extends String>> FARM_BAMBOO_PRODUCTS;
    public static ModConfigSpec.ConfigValue<List<? extends String>> FARM_BEE_PRODUCTS;
    public static ModConfigSpec.ConfigValue<List<? extends String>> FARM_BLAZE_PRODUCTS;
    public static ModConfigSpec.ConfigValue<List<? extends String>> FARM_BONE_MEAL_PRODUCTS;
    public static ModConfigSpec.ConfigValue<List<? extends String>> FARM_CHICKEN_PRODUCTS;
    public static ModConfigSpec.ConfigValue<List<? extends String>> FARM_COBBLESTONE_PRODUCTS;
    public static ModConfigSpec.ConfigValue<List<? extends String>> FARM_COW_PRODUCTS;
    public static ModConfigSpec.ConfigValue<List<? extends String>> FARM_CREEPER_PRODUCTS;
    public static ModConfigSpec.ConfigValue<List<? extends String>> FARM_DROWNED_PRODUCTS;
    public static ModConfigSpec.ConfigValue<List<? extends String>> FARM_ENDERMAN_PRODUCTS;
    public static ModConfigSpec.ConfigValue<List<? extends String>> FARM_ENDER_DRAGON_PRODUCTS;
    public static ModConfigSpec.ConfigValue<List<? extends String>> FARM_EVOKER_PRODUCTS;
    public static ModConfigSpec.ConfigValue<List<? extends String>> FARM_FROG_PRODUCTS;
    public static ModConfigSpec.ConfigValue<List<? extends String>> FARM_GHAST_PRODUCTS;
    public static ModConfigSpec.ConfigValue<List<? extends String>> FARM_GUARDIAN_PRODUCTS;
    public static ModConfigSpec.ConfigValue<List<? extends String>> FARM_HOGLIN_PRODUCTS;
    public static ModConfigSpec.ConfigValue<List<? extends String>> FARM_ICE_PRODUCTS;
    public static ModConfigSpec.ConfigValue<List<? extends String>> FARM_IRON_GOLEM_PRODUCTS;
    public static ModConfigSpec.ConfigValue<List<? extends String>> FARM_MAGMA_CUBE_PRODUCTS;
    public static ModConfigSpec.ConfigValue<List<? extends String>> FARM_PHANTOM_PRODUCTS;
    public static ModConfigSpec.ConfigValue<List<? extends String>> FARM_PIG_PRODUCTS;
    public static ModConfigSpec.ConfigValue<List<? extends String>> FARM_PILLAGER_PRODUCTS;
    public static ModConfigSpec.ConfigValue<List<? extends String>> FARM_RABBIT_PRODUCTS;
    public static ModConfigSpec.ConfigValue<List<? extends String>> FARM_RAVAGER_PRODUCTS;
    public static ModConfigSpec.ConfigValue<List<? extends String>> FARM_SHEEP_PRODUCTS;
    public static ModConfigSpec.ConfigValue<List<? extends String>> FARM_SHULKER_PRODUCTS;
    public static ModConfigSpec.ConfigValue<List<? extends String>> FARM_SKELETON_PRODUCTS;
    public static ModConfigSpec.ConfigValue<List<? extends String>> FARM_SLIME_PRODUCTS;
    public static ModConfigSpec.ConfigValue<List<? extends String>> FARM_SPIDER_PRODUCTS;
    public static ModConfigSpec.ConfigValue<List<? extends String>> FARM_SQUID_PRODUCTS;
    public static ModConfigSpec.ConfigValue<List<? extends String>> FARM_SUGAR_CANES_PRODUCTS;
    public static ModConfigSpec.ConfigValue<List<? extends String>> FARM_VILLAGER_PRODUCTS;
    public static ModConfigSpec.ConfigValue<List<? extends String>> FARM_WARDEN_PRODUCTS;
    public static ModConfigSpec.ConfigValue<List<? extends String>> FARM_WITCH_PRODUCTS;
    public static ModConfigSpec.ConfigValue<List<? extends String>> FARM_WITHER_PRODUCTS;
    public static ModConfigSpec.ConfigValue<List<? extends String>> FARM_WITHER_SKELETON_PRODUCTS;
    public static ModConfigSpec.ConfigValue<List<? extends String>> FARM_WOOD_PRODUCTS;
    public static ModConfigSpec.ConfigValue<List<? extends String>> FARM_ZOMBIE_PRODUCTS;
    ...
    static {
        ...
        FARMLAND_TICK_INTERVAL = builder.comment("每多少 tick 检查一次作物生长。默认 1").defineInRange("tick_interval", 1, 1, Integer.MAX_VALUE);
        FARMLAND_GROWTH_AMOUNT = builder.comment("每次增加的生长阶段数。-1 时直接设为最大生长阶段").defineInRange("growth_amount", -1, -1, Integer.MAX_VALUE);
        FARMLAND_BONEMEAL_ENABLED = builder.comment("是否额外对 BonemealableBlock 施放骨粉效果").define("bonemeal_enabled", true);
        FARMLAND_BONEMEAL_INTERVAL = builder.comment("每多少 tick 额外施放一次骨粉").defineInRange("bonemeal_interval", 1, 1, Integer.MAX_VALUE);
        builder.pop();

        builder.comment("时钟方块设置").push("clock");
        CLOCK_DEFAULT_ACTIVE = builder.comment("进入游戏后时钟的初始开关状态").define("default_active", false);
        builder.pop();

        builder.comment("永恒图腾设置").push("eternal_totem");
        ETERNAL_TOTEM_DEFAULT_ENABLED = builder.comment("永恒图腾的初始开关状态").define("default_enabled", false);
        ETERNAL_TOTEM_TANK_CONVERSION = builder.comment("是否允许右键 Mekanism 终极化学品储罐升级为创造化学品储罐").define("tank_conversion", true);
        builder.pop();

        builder.comment("农场设置").push("farm");
        FARM_LEVEL_UP_INTERVAL_SECONDS = builder.comment("农场升级间隔（秒）").defineInRange("level_up_interval_seconds", 20, 1, Integer.MAX_VALUE);
        FARM_CARRY = builder.comment("进位阈值。产出累加至此值后进位为完整物品").defineInRange("carry", 10000L, 1L, Long.MAX_VALUE);
        FARM_INITIAL_LEVEL = builder.comment("农场初始等级").defineInRange("initial_level", 1L, 1L, Long.MAX_VALUE);
        FARM_MAX_LEVEL = builder.comment("农场最大等级（达到后不再升级）").defineInRange("max_level", Long.MAX_VALUE, 1L, Long.MAX_VALUE);
        ...
        POTION_COMBINE_DURATION_FACTOR = builder.comment("两瓶药水同等级效果合并时，持续时间系数。公式: (时间A + 时间B) × 此系数").defineInRange("duration_factor", 0.75, 0.5, 1.0);
        builder.pop();

        builder.comment("存储方块制造机设置").push("storage_fountain");
        STORAGE_FOUNTAIN_MAX_ITEM_TYPES = builder.comment("最多可存储的物品类型数量").defineInRange("max_item_types", 9, 1, Integer.MAX_VALUE);
        STORAGE_FOUNTAIN_CARRY = builder.comment("进位阈值。内部计数单位 = 此值").defineInRange("carry", 1000L, 1L, Long.MAX_VALUE);
        STORAGE_FOUNTAIN_GROWTH_INTERVAL_SECONDS = builder.comment("每次增长间隔（秒）").defineInRange("growth_interval_seconds", 20, 1, Integer.MAX_VALUE);
        STORAGE_FOUNTAIN_GROWTH_STEP = builder.comment("每次增长时 output 的增加量").defineInRange("growth_step", 5L, 0L, Long.MAX_VALUE);
        STORAGE_FOUNTAIN_INITIAL_OUTPUT = builder.comment("初始产出速率").defineInRange("initial_output", 5L, 0L, Long.MAX_VALUE);
        STORAGE_FOUNTAIN_ACCEPTED_MODS = builder.comment("额外接受的 MOD 命名空间列表").defineList("accepted_mods", () -> List.of("modern_industrialization", "extended_industrialization"), o -> o instanceof String);
        STORAGE_FOUNTAIN_ACCEPTED_TAGS = builder.comment("接受的物品标签路径片段列表").defineList("accepted_tags", () -> List.of("storage_blocks", "ores", "ingots", "dusts", "gems", "alloys", "plates", "enriched", "circuits", "pellets", "matter", "klein_star"), o -> o instanceof String);
        builder.pop();
